...
var prototypeAccessors = { ROARS: { configurable: true },cubs: { configurable: true },attributes: { configurable: true } };
...
export default function (tagName, attributes, cubs) { return new Lion(tagName, attributes, cubs); };

export { Lion, xmlion };
//# sourceMappingURL=xmlion.es.js.map
